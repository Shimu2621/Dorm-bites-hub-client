...
const MealEditModal: React.FC<MealEditModalProps> = ({
  ...
  const [meal, setMeal] = useState<IMealTypes | null>(null);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-w-lg mx-auto p-6 bg-secondary rounded-lg shadow-lg space-y-4">
        <DialogHeader>
