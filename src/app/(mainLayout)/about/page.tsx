    ...
    <div className="container mx-auto  ">
      ...
      <div className="relative w-full h-[30vh] md:h-[40vh] ">
        ...
        <div className="absolute inset-0 bg-black/70">
          {/* text */}
          <div
            className="relative mt-20 text-default-white flex flex-col items-center justify-center"
            data-aos="fade-up"
          >
      ...
      <div className="flex flex-col pt-14 md:flex-row items-center justify-between mb-16 max-w-[1440px] mx-auto gap-20">
        ...
        <div className="w-full md:w-1/2 pt-24 px-2" data-aos="fade-right">
          ...
          <h1 className="text-2xl md:text-3xl italic font-bold text-text-white mb-6">
      ...
      <div className="max-w-[1440px] pt-28 mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 max-w-[1440px] mx-auto px-10 gap-6 mb-20">
          ...
          >
            ...
            <h2 className="font-bold text-xl mb-4">Ava Thompson</h2>
          ...
          >
            ...
            <h2 className="font-bold text-xl mb-4">Liam Patel</h2>
            <p className="text-center text-gray-color">
          ...
          >
            ...
            <h2 className="font-bold text-xl mb-4">Sophia Martinez</h2>
            <p className="text-center text-gray-color">
          ...
          >
            ...
            <h2 className="font-bold text-xl mb-4">Noah Kim</h2>
            <p className="text-center text-gray-color">
